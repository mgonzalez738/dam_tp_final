...
const routes = [
    ...
    {
        path: ':id',
        loadChildren: () => Promise.all(/*! import() | dispositivo-dispositivo-module */[__webpack_require__.e("common"), __webpack_require__.e("dispositivo-dispositivo-module")]).then(__webpack_require__.bind(null, /*! ../dispositivo/dispositivo.module */ "./src/app/dispositivo/dispositivo.module.ts")).then(m => m.DispositivoPageModule)
    },
    {
        path: ':id/logsRiego',
        loadChildren: () => Promise.all(/*! import() | log-riego-log-riego-module */[__webpack_require__.e("common"), __webpack_require__.e("log-riego-log-riego-module")]).then(__webpack_require__.bind(null, /*! ../log-riego/log-riego.module */ "./src/app/log-riego/log-riego.module.ts")).then(m => m.LogRiegoPageModule)
    },
    {
        path: ':id/mediciones',
        loadChildren: () => Promise.all(/*! import() | medicion-medicion-module */[__webpack_require__.e("common"), __webpack_require__.e("medicion-medicion-module")]).then(__webpack_require__.bind(null, /*! ../medicion/medicion.module */ "./src/app/medicion/medicion.module.ts")).then(m => m.MedicionPageModule)
    }
];
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _services_dispositivo_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/dispositivo.service */ "./src/app/services/dispositivo.service.ts");
...
let DispositivoService = class DispositivoService {
    ...
    getListadoDispositivos() {
        return this._http.get(this.urlApi + "/api/dispositivos/").toPromise().then((dispositivos) => {
            return dispositivos;
        });
    }
    getDispositivo(id) {
        return this._http.get(this.urlApi + "/api/dispositivos/" + id).toPromise().then((dispositivo) => {
            return dispositivo;
        });
    }
    ;
